...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int valueOne = 10; //자료형 선언가 함께 값 대입가능
        int valueTwo = 20;

        int valueThree = 100, valueFour = 1000; // 같은 자료형을 옆으로 늘여서 선언
        ...
        //int Three&Four; // 특수문자 불가능
        int $power; // 그중 $는 가능하지만 특수한경우에만 사용하기에 쓰지마세요

        // Code Convention

        int valueOfComputer; // 처은엔 소문자로시작하고 단어가바뀔떼마다 대문자사용 = camelCase= camelNotation
